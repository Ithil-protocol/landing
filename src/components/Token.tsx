...
const Token = (props: {
  ...
  return (
    <div
      ...
      tw="rounded-xl bg-secondary-300 flex flex-col justify-between p-6 gap-3  tablet:min-width[170px] desktop:min-width[15.4vw]"
    >
      <img tw="w-12 h-12" src={Icon} alt="token icon" />
      <div tw="flex flex-col tablet:flex-row justify-between">
        <Txt.Heading2 tw="text-primary tablet:text-body2-regular mb-2 tablet:mb-0">
          {tokenSymbol}
        </Txt.Heading2>
