...
export const Header = (props: { siteTitle?: any }) => {
  ...
  return (
    <Layout fixed bgDefault header>
      <nav className={`${scrolled ? 'flex' : 'hidden'} flex-wrap items-center justify-between py-4 max-w-1920 w-full tablet:m-[calc(100% - 3rem)] px-4 tablet:px-24`}>
